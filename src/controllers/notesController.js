export default class NotesController {
    constructor(model, view, trashview, handleview) {
        this.model = model;
        this.view = view;
        ...
        this.trashview.setEventHandlers(
            ...
            this.deletePermanent.bind(this)
        );

        this.handleview.notesPage.addEventListener('click', () => this.loadNotesList());
        this.handleview.trashPage.addEventListener('click', () => this.loadTrash());
    ...
    async deletePermanent(id) {
        ...
        this.cacheNotes.notes = this.cacheNotes.notes.filter(n => n.id !== id); // Remove permanently in cache
        this.trashview.renderTrashNotes(this.cacheNotes.notes);
        //this.view.renderNotes(this.cacheNotes.notes);
        }
    ...
    async editNote(id) {
        ...
        <div class="modal-content">
            ...
            <div class="button-group">
                <button id="saveNote" class="save"><i class="fas fa-save"></i> Save</button>
            </div>
        </div>
    `;
        ...
        const quill = new Quill("#quillEditor", {
            theme: "snow", // 'snow' is the default clean theme
        ...
        // Set the editor content from the note
        ...
        document.getElementById('saveNote').addEventListener('click', async () => {
            ...
            await this.model.updateNote(id, newTitle, updatedText, note.pinned, note.position, false);
    
            note.title = newTitle;
            note.text = updatedText;
    
            // this.view.renderNotes(this.cacheNotes.notes);
           this.view.updateNoteElement({ 
            id, 
            title: newTitle, 
            text: updatedText 
        });
